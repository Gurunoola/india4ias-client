    ...
    <div className=''>
      ...
      <div className='col-md-12 p-4 bg-white text-center text-md-left text-lg-left '>
        <div className='row m-0 p-0'>
          ...
          <div className='col-md-5'>
            <div className='col p-1'><Icon toolTip={{title: labels.CLASS, placement: 'left'}} icon={'easel'} size='14px' type={'primary'}/> {upperCase(formData && formData.class && formData.class.name + formData.class.section)}</div>
